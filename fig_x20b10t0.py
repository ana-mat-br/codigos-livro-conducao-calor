"""
Gera a figura do Problema X20B1T0 no padrão editorial do livro.
Saída: ../figuras/cap3/Tx20_fig.pdf
"""
import numpy as np
...
ax.set_title('Campo de temperatura transiente --- Problema X20B1T0')
ax.legend(loc='upper left')
ax.grid(True, linestyle='--', linewidth=0.4, alpha=0.6)
fig.savefig('../figuras/cap3/Tx20_fig.pdf', backend='pdf')
plt.show()
