"""
Gera a figura do Problema X21B10T0 no padrão editorial do livro.
Saída: ../figuras/cap2/Tx21_fig.pdf
"""
import numpy as np
...
ax.set_title('Campo de temperatura transiente --- Problema X21B10T0')
